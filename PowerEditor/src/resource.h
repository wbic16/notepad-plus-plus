...
#define MENUINDEX_PHEXT    4
#define MENUINDEX_FORMAT   5
#define MENUINDEX_LANGUAGE 6
#define MENUINDEX_SETTINGS 7
#define MENUINDEX_TOOLS    8
#define MENUINDEX_MACRO    9
#define MENUINDEX_RUN      10
#define MENUINDEX_PLUGINS  11
#define MENUINDEX_WINDOW   12
#define MENUINDEX_HELP     13
#define MENUINDEX_LIST     15
