...
#define    IDM_PHEXT     (IDM + 5000)
    #define    IDM_PHEXT_SCROLL_UP                (IDM_PHEXT + 1)
    #define    IDM_PHEXT_SCROLL_DOWN              (IDM_PHEXT + 2)
    #define    IDM_PHEXT_SECTION_UP               (IDM_PHEXT + 3)
    #define    IDM_PHEXT_SECTION_DOWN             (IDM_PHEXT + 4)
    #define    IDM_PHEXT_CHAPTER_UP               (IDM_PHEXT + 5)
    #define    IDM_PHEXT_CHAPTER_DOWN             (IDM_PHEXT + 6)
    #define    IDM_PHEXT_BOOK_UP                  (IDM_PHEXT + 7)
    #define    IDM_PHEXT_BOOK_DOWN                (IDM_PHEXT + 8)
    #define    IDM_PHEXT_VOLUME_UP                (IDM_PHEXT + 9)
    #define    IDM_PHEXT_VOLUME_DOWN              (IDM_PHEXT + 10)
    #define    IDM_PHEXT_COLLECTION_UP            (IDM_PHEXT + 11)
    #define    IDM_PHEXT_COLLECTION_DOWN          (IDM_PHEXT + 12)
    #define    IDM_PHEXT_SERIES_UP                (IDM_PHEXT + 13)
    #define    IDM_PHEXT_SERIES_DOWN              (IDM_PHEXT + 14)
    #define    IDM_PHEXT_SHELF_UP                 (IDM_PHEXT + 15)
    #define    IDM_PHEXT_SHELF_DOWN               (IDM_PHEXT + 16)
    #define    IDM_PHEXT_LIBRARY_UP               (IDM_PHEXT + 17)
    #define    IDM_PHEXT_LIBRARY_DOWN             (IDM_PHEXT + 18)

#define    IDM_FORMAT    (IDM + 5500)
...
//    #define    IDM_SETTING_EDGE_SIZE                (IDM_SETTING + 4)
    ...
    #define    IDM_SETTING_PHEXT_ENTER_IS_RETURN     (IDM_SETTING + 19)
    #define    IDM_SETTING_PHEXT_ENTER_IS_SCROLL     (IDM_SETTING + 20)
    #define    IDM_SETTING_PHEXT_ENTER_IS_SECTION    (IDM_SETTING + 21)
    #define    IDM_SETTING_PHEXT_ENTER_IS_CHAPTER    (IDM_SETTING + 22)
    #define    IDM_SETTING_PHEXT_ENTER_IS_BOOK       (IDM_SETTING + 23)
    #define    IDM_SETTING_PHEXT_ENTER_IS_VOLUME     (IDM_SETTING + 24)
    #define    IDM_SETTING_PHEXT_ENTER_IS_COLLECTION (IDM_SETTING + 25)
    #define    IDM_SETTING_PHEXT_ENTER_IS_SERIES     (IDM_SETTING + 26)
    #define    IDM_SETTING_PHEXT_ENTER_IS_SHELF      (IDM_SETTING + 27)
    #define    IDM_SETTING_PHEXT_ENTER_IS_LIBRARY    (IDM_SETTING + 28)
